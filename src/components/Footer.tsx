...
export default function Footer() {
  return (
    <footer className="bg-white mt-16 sm:mt-20 lg:mt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              />
              <span className="ml-2 text-lg sm:text-xl font-bold">Only Food</span>
            </div>
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              Discover and share amazing recipes from around the world.
              Cook, share, and enjoy delicious meals with our community.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-gray-600 hover:text-orange-500 text-sm sm:text-base transition-colors"
                >
                  Home
                </Link>
              </li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-600 text-sm">
              © 2025 Only Food. All rights reserved.
            </p>
